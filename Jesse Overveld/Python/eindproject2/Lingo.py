...
#Spel start
kies_woord = randint(0,1278) #Pakt een woord uit de 1279 woorden uit names.txt
...
urllib.request.urlopen('https://www.vandale.nl/gratis-woordenboek/nederlands/betekenis/')
print(page.read())
